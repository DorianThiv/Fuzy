...
namespace FuzyAppRest.Entity.Context
{
    public partial class FuzyAppRestContext : DbContext
    {

        public FuzyAppRestContext(DbContextOptions<FuzyAppRestContext> options) : base(options)
        {
        }

        public DbSet<ActionDo> Actions { get; set; }
