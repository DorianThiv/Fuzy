...
namespace FuzyAppRest.Entity.UnitofWork
{
    public interface IUnitOfWork : IDisposable
    {
        ...
        FuzyAppRestContext Context { get; }
        int Save();
        Task<int> SaveAsync();
    }
    ...
    {
        public FuzyAppRestContext Context { get; }

        private Dictionary<Type, object> _repositoriesAsync;
        private Dictionary<Type, object> _repositories;
        private bool _disposed;

        public UnitOfWork(FuzyAppRestContext context)
        {
            Context = context;
            _disposed = false;
        }
